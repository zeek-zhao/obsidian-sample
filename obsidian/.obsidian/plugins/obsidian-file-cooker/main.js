...
// src/modal/modal-ui.ts
var import_obsidian = __toModule(require("obsidian"));
function renderModalLayout(contentEl, options) {
...
function addModalActions(contentEl, actions) {
  const actionSetting = new import_obsidian.Setting(contentEl);
...
function addLabeledTextField(contentEl, label, placeholder, onChange) {
  ...
  new import_obsidian.Setting(fieldRow).addText((txt) => {
    txt.setPlaceholder(placeholder).onChange((val) => {
      onChange(val);
    });
  });
}
function addLabeledToggleField(contentEl, label, tooltip, initialValue, onChange) {
  const fieldRow = contentEl.createDiv({ cls: "file-cooker-modal__field-row" });
  fieldRow.createDiv({ text: label, cls: "file-cooker-modal__field-label" });
  new import_obsidian.Setting(fieldRow).addToggle((toggle) => {
  ...
  onOpen() {
    return __async(this, null, function* () {
      ...
      renderModalLayout(contentEl, {
        ...
        summaryLines: this.resultArr.length > 0 ? [`${this.resultArr.length} files will be deleted permanently.`] : void 0,
        ...
        addModalActions(contentEl, [
          {
            ...
            onClick: () => {
              ...
              new import_obsidian2.Notice("Delete completed.");
            }
          },
          {
            text: "Cancel",
            onClick: () => {
              this.close();
              new import_obsidian2.Notice("Operation canceled.");
            }
          }
        ]);
      }
...
var DeleteAction = class {
  ...
  act(actionModels) {
    if (actionModels.length > 0) {
      ...
      new import_obsidian3.Notice("No Files Found!");
    }
  }
};
...
var EditPropertiesModal = class extends import_obsidian4.Modal {
  constructor(app, resultArr) {
    super(app);
    this.resultArr = resultArr;
  ...
  onOpen() {
    ...
    if (this.resultArr.length === 0) {
      ...
      addLabeledToggleField(contentEl, "Override Existing", "Override if exists!", Boolean(this.overrideFlag), (val) => {
      ...
      addModalActions(contentEl, [
        {
          ...
          onClick: () => __async(this, null, function* () {
            ...
            for (let i = 0; i < this.resultArr.length; i++) {
              const info = this.resultArr[i];
              const self2 = this;
              this.app.fileManager.processFrontMatter(info, (props) => {
                const k = self2.key.trim();
                const v = self2.val.trim();
                if (k === "tags" || k === "alias" || k === "cssclasses") {
                  ...
                  delete props[k];
                } else if (self2.overrideFlag || !props[k]) {
                  props[k] = v;
                }
              });
            }
            new import_obsidian4.Notice("Properties updated.");
          })
        },
        {
          text: "Cancel",
          onClick: () => {
            this.close();
            new import_obsidian4.Notice("Operation canceled.");
          }
        }
      ]);
    }
...
var EditPropertiesAction = class {
  ...
  act(actionModels) {
    if (actionModels.length > 0) {
      ...
      new import_obsidian5.Notice("No Files Found!");
    }
  }
};
...
var MoveConfirmModal = class extends import_obsidian6.Modal {
  ...
  onOpen() {
    var _a, _b;
    const { contentEl } = this;
    const targetDir = (_b = (_a = this.moveInfos[0]) == null ? void 0 : _a.targetDir) != null ? _b : "-";
    ...
    addModalActions(contentEl, [
      ...
      },
      {
        ...
        onClick: () => {
          this.close();
          new import_obsidian6.Notice("Operation canceled.");
        }
      }
    ]);
  }
...
// src/modal/rename-confirm-modal.ts
var RenameConfirmModal = class extends import_obsidian8.Modal {
    ...
    addModalActions(contentEl, [
      {
        ...
        onClick: () => __async(this, null, function* () {
          if ((this.prefix == null || this.prefix.trim() == "") && (this.suffix == null || this.suffix.trim() == "")) {
            new import_obsidian8.Notice("Prefix or suffix is required.");
            return;
          }
          this.close();
          for (let i = 0; i < this.resultArr.length; i++) {
          ...
          new import_obsidian8.Notice("Rename completed.");
        })
      },
      {
        text: "Cancel",
        onClick: () => {
          this.close();
          new import_obsidian8.Notice("Operation canceled.");
        }
      }
    ]);
  }
      ...
      addModalActions(contentEl, [
        {
          ...
          cta: true,
          onClick: () => __async(this, null, function* () {
            if (isBlank(this.prefix) && isBlank(this.suffix)) {
        ...
        },
        {
          ...
          onClick: () => {
            this.close();
            new import_obsidian9.Notice("Operation canceled.");
          }
        }
      ]);
    }
...
var RenameAction = class {
  ...
  act(actionModels) {
    if (actionModels.length > 0) {
      ...
      new import_obsidian10.Notice("No Files Found!");
    }
  }
};
...
var SyncFlomoConfirmModal = class extends import_obsidian11.Modal {
      ...
      addModalActions(contentEl, [
        {
          ...
          onClick: () => __async(this, null, function* () {
            ...
            for (let i = 0; i < this.actionModels.length; i++) {
              ...
              const cont = info.file ? yield this.app.vault.read(info.file) : info.content;
              ...
              if (!response.ok) {
                new import_obsidian11.Notice(`Sync failed [${response.status}].`);
                return;
              }
            }
            new import_obsidian11.Notice("Sync completed.");
          })
        },
        {
          text: "Cancel",
          onClick: () => {
            this.close();
            new import_obsidian11.Notice("Operation canceled.");
          }
        }
      ]);
    });
...
var SyncFlomoAction = class {
  ...
  act(actionModels) {
    ...
    if (!flomoAPI || flomoAPI.trim() == "") {
      new import_obsidian12.Notice("Please config flomoAPI first!");
      return;
    }
    if (actionModels.length > 0) {
...
var height = 400;
var between = 40;
var AddToCanvasConfirmModal = class extends import_obsidian13.Modal {
  constructor(app, actionModels, targetFilePath) {
    super(app);
  ...
  addContent() {
    ...
    new import_obsidian13.Setting(contentEl).addButton((btn) => btn.setButtonText("Add to canvas").setCta().onClick(() => __async(this, null, function* () {
      this.close();
      ...
      if ((canvasView == null ? void 0 : canvasView.getViewType()) === "canvas") {
        ...
        canvas.requestSave();
        new import_obsidian13.Notice("Added to canvas.");
      } else {
        new import_obsidian13.Notice(this.targetFilePath + " is not a Canvas!");
      }
    }))).addButton((btn) => btn.setButtonText("Cancel").setCta().onClick(() => {
      this.close();
      new import_obsidian13.Notice("Operation canceled.");
    }));
  }
  getCanvas() {
    return __async(this, null, function* () {
  ...
  createFileNode(canvas, file, idx) {
    let tempChildNode;
    if (!(0, import_obsidian13.requireApiVersion)("1.1.10")) {
...
// src/modal/choose-canvas-modal.ts
var ChooseCanvasModal = class extends import_obsidian15.SuggestModal {
  ...
  getSuggestions(query) {
    ...
    abstractFiles.forEach((file) => {
      if (file instanceof import_obsidian15.TFile && file.path.toLowerCase().contains(lowerCaseInputStr) && file.path.toLowerCase().endsWith(".canvas")) {
...
// src/modal/merge-confirm-modal.ts
var MergeConfirmModal = class extends import_obsidian16.Modal {
    ...
    addModalActions(contentEl, [
      {
        ...
        onClick: () => __async(this, null, function* () {
          ...
          new import_obsidian16.Notice("Files merged.");
        })
      },
      {
        text: "Cancel",
        onClick: () => {
          this.close();
          new import_obsidian16.Notice("Operation canceled.");
        }
      }
    ]);
  }
...
// src/modal/choose-file-modal.ts
var ChooseFileModal = class extends import_obsidian18.SuggestModal {
  constructor(app, readable) {
    super(app);
    this.readable = readable;
  }
  getSuggestions(query) {
    ...
    const lowerCaseInputStr = query.toLowerCase();
    abstractFiles.forEach((file) => {
      if (file instanceof import_obsidian18.TFile && file.path.toLowerCase().contains(lowerCaseInputStr)) {
        files.push(file.path);
      }
    });
    if (files.length == 0) {
...
var ChooseFolderModal = class extends import_obsidian19.SuggestModal {
  ...
  getSuggestions(query) {
    ...
    abstractFiles.forEach((folder) => {
      if (folder instanceof import_obsidian19.TFolder && folder.path.toLowerCase().contains(lowerCaseInputStr)) {
        folders.push(folder);
      }
    });
    return folders;
...
var ClipboardReader = class {
  ...
  read(action) {
    ...
    promiseStr.then((str) => {
      ...
      new import_obsidian20.Notice("Clipboard File Content Error!" + e);
    });
  }
};
...
var ClipboardContentReader = class {
  ...
  read(action) {
    ...
    promiseStr.then((str) => {
      ...
      new import_obsidian21.Notice("Clipboard Content Error!" + e);
    });
  }
};
...
var CreateConfirmModal = class extends import_obsidian22.Modal {
  constructor(app, moveInfos) {
    super(app);
    this.moveInfos = moveInfos;
  }
    ...
    addModalActions(contentEl, [
      {
        ...
        onClick: () => __async(this, null, function* () {
          ...
          new import_obsidian22.Notice("Files created.");
        })
      },
      {
        text: "Cancel",
        onClick: () => {
          this.close();
          new import_obsidian22.Notice("Operation canceled.");
        }
      }
    ]);
  }
...
var CreateAction = class {
  ...
  act(actionModels) {
    ...
    if (actionModels.length > 0) {
      ...
      new import_obsidian23.Notice("No Files Found!");
    }
  }
};
...
var CurrentFileReader = class {
  ...
  read(action) {
    ...
    try {
      ...
      new import_obsidian24.Notice(e.message);
    }
  }
};
...
var CopyToClipboardConfirmModal = class extends import_obsidian25.Modal {
  constructor(app, resultArr) {
    super(app);
    this.resultArr = resultArr;
    this.lineBreak = getLinebreak();
  ...
  onOpen() {
    ...
    new import_obsidian25.Setting(contentEl).addButton((btn) => btn.setButtonText("Copy links").setCta().onClick(() => __async(this, null, function* () {
      this.close();
      let str = this.prepareStr();
      navigator.clipboard.writeText(str);
      new import_obsidian25.Notice("Links copied.");
    }))).addButton((btn) => btn.setButtonText("Cancel").setCta().onClick(() => {
      this.close();
      new import_obsidian25.Notice("Operation canceled.");
    }));
  }
  prepareStr() {
    let str = "";
...
var CopyAction = class {
  ...
  act(actionModels) {
    if (actionModels.length > 0) {
      ...
      new import_obsidian26.Notice("No Files Found!");
    }
  }
};
  ...
  read(action) {
    ...
    if (idx > 0) {
      ...
      try {
        ...
        new import_obsidian27.Notice(e.message);
      }
    } else {
      api.query(qStr).then((res) => {
        if (res.successful) {
          ...
          if (res.value.type == "list") {
            ...
            res.value.values.forEach((it) => {
              var _a;
              if ("link" in it && ((_a = it.link) == null ? void 0 : _a.path)) {
          ...
          try {
            if (this.taskFlag) {
              ...
              res.value.values.forEach((it) => {
                var _a;
                if ("link" in it && "text" in it && ((_a = it.link) == null ? void 0 : _a.path)) {
          ...
          new import_obsidian27.Notice("Query string error![" + this.queryStr + "]");
        }
      });
    }
  }
...
var SearchResultsReader = class {
  ...
  read(action) {
    ...
    let results = (_b = (_a = searchLeaf == null ? void 0 : searchLeaf.view) == null ? void 0 : _a.dom) == null ? void 0 : _b.resultDomLookup;
    if (results == null || results.size == 0) {
      new import_obsidian28.Notice("Has no search results!Please search first!");
    } else {
...
// src/command/context-menu-command.ts
var import_obsidian29 = __toModule(require("obsidian"));
function hasEditorSelection(editor) {
  return editor.getSelection().trim() !== "";
}
function toSingleFileActionModel(target) {
  const maybeFile = target;
  if (typeof (maybeFile == null ? void 0 : maybeFile.extension) === "string") {
...
var ContextMenuCommand = class {
  ...
  registSelectionOperations(menu, editor) {
    ...
    menu.addItem((item) => {
      item.setTitle("Sync selection to flomo ...").onClick(() => {
        new CurrentFileReader(this.plugin, ReadType.SELECTION, editor.getSelection()).read(new SyncFlomoAction(this.plugin));
      });
    });
    menu.addItem((item) => {
      item.setTitle("Add selection in current file to canvas ...").onClick(() => {
        new ChooseCanvasModal(this.plugin.app, new CurrentFileReader(this.plugin, ReadType.SELECTION, editor.getSelection())).open();
      });
    });
    return true;
  }
  registCurrentFileLinkOperations(menu) {
    if (!this.hasActiveFileContext()) {
      return false;
    }
    this.addGroupTitle(menu, "File Cooker -> Current file links");
    menu.addItem((item) => {
      item.setTitle("Rename in current file links ...").onClick(() => {
        this.runCurrentFileLinkAction(() => new RenameAction(this.plugin.app));
      });
    });
    menu.addItem((item) => {
      item.setTitle("Edit Properties in current file links ...").onClick(() => {
        this.runCurrentFileLinkAction(() => new EditPropertiesAction(this.plugin.app));
      });
    });
    menu.addItem((item) => {
      item.setTitle("Delete link-files in current file!").onClick(() => {
        this.runCurrentFileLinkAction(() => new DeleteAction(this.plugin.app));
      });
      this.trySetWarning(item, true);
    });
    menu.addItem((item) => {
      item.setTitle("Add links in current file to target canvas ...").onClick(() => {
        new ChooseCanvasModal(this.plugin.app, new CurrentFileReader(this.plugin)).open();
      });
    });
    return true;
  }
  addGroupTitle(menu, title) {
    menu.addItem((item) => {
      item.setTitle(title).setDisabled(true);
      this.trySetIsLabel(item, true);
    });
  }
  trySetIsLabel(item, isLabel) {
    if (typeof item.setIsLabel === "function") {
      item.setIsLabel(isLabel);
    }
  }
  trySetWarning(item, isWarning) {
  ...
  runCurrentFileLinkAction(actionFactory) {
    if (!this.hasActiveFileContext()) {
  ...
  runTargetFileAction(actionModel, actionFactory) {
    actionFactory().act([actionModel]);
  }
};

// src/reader/bases-reader.ts
var import_obsidian30 = __toModule(require("obsidian"));
var BASES_UNAVAILABLE_NOTICE = "Bases results unavailable! Please open a Bases query view and run a query first!";
var BASES_EMPTY_NOTICE = "Has no bases results! Please run a query first!";
var BASES_NO_FILES_NOTICE = "No Files Found!";
var BasesReader = class {
  constructor(plugin, taskFlag) {
    this.plugin = plugin;
    this.app = plugin.app;
  ...
  read(action) {
    ...
    if (rows == null) {
      new import_obsidian30.Notice(BASES_UNAVAILABLE_NOTICE);
      return;
    }
    if (rows.length === 0) {
      new import_obsidian30.Notice(BASES_EMPTY_NOTICE);
      return;
    }
    ...
    if (ignoredCount > 0) {
      new import_obsidian30.Notice(`Ignored ${ignoredCount} non-file bases results.`);
    }
    ...
    if (models.length === 0) {
      ...
      console.log("[File Cooker][BasesReader] No file mapped from bases rows.", {
        ...
        firstRowFunctionKeys: typeof firstRow === "function" ? Object.keys(firstRow) : void 0
      });
      new import_obsidian30.Notice(`Bases rows detected but none mapped. First row keys: ${keys}`);
      new import_obsidian30.Notice(BASES_NO_FILES_NOTICE);
      return;
    }
    if (this.taskFlag) {
      const contentModels = [];
      const lines = models.filter((model) => model.file != null).map((model) => `- [ ] [[${model.file.path}]]`);
...
function resolveBasesRows(app) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o;
  const pluginCandidates = [
    (_b = (_a = app == null ? void 0 : app.plugins) == null ? void 0 : _a.plugins) == null ? void 0 : _b.bases,
    (_d = (_c = app == null ? void 0 : app.plugins) == null ? void 0 : _c.plugins) == null ? void 0 : _d["obsidian-bases"],
    (_f = (_e = app == null ? void 0 : app.plugins) == null ? void 0 : _e.plugins) == null ? void 0 : _f["bases-plugin"],
    (_i = (_h = (_g = app == null ? void 0 : app.internalPlugins) == null ? void 0 : _g.plugins) == null ? void 0 : _h.bases) == null ? void 0 : _i.instance
  ];
  for (const pluginInstance of pluginCandidates) {
    const api = pluginInstance == null ? void 0 : pluginInstance.api;
    const apiResults = (_l = (_k = (_j = callIfFunction(api == null ? void 0 : api.getActiveQueryResults)) != null ? _j : callIfFunction(api == null ? void 0 : api.getQueryResults)) != null ? _k : callIfFunction(pluginInstance == null ? void 0 : pluginInstance.getActiveQueryResults)) != null ? _l : callIfFunction(pluginInstance == null ? void 0 : pluginInstance.getQueryResults);
  ...
  for (const leafType of leafTypeCandidates) {
    const leaves = (_m = app.workspace.getLeavesOfType(leafType)) != null ? _m : [];
    for (const leaf of leaves) {
      const normalized = normalizeRowsFromView(leaf == null ? void 0 : leaf.view);
      if (normalized != null) {
        return normalized;
      }
    }
  }
  const activeLeafView = (_o = (_n = app.workspace) == null ? void 0 : _n.activeLeaf) == null ? void 0 : _o.view;
  ...
  if (typeof workspaceAsAny.iterateAllLeaves === "function") {
    ...
    workspaceAsAny.iterateAllLeaves((leaf) => {
      ...
      const deepRows = discoverRowsDeep(leaf == null ? void 0 : leaf.view);
      if (deepRows != null) {
...
function normalizeRows(raw) {
  ...
  if (raw != null && typeof raw === "object") {
    const rows = (_b = (_a = raw.rows) != null ? _a : raw.items) != null ? _b : raw.results;
...
function normalizeRowsFromView(view) {
  var _a, _b, _c, _d, _e, _f, _g, _h, _i;
  if (view == null) {
    return null;
  }
  const viewResult = (_i = (_g = (_e = (_c = (_b = (_a = view.currentQueryResult) != null ? _a : view.queryResult) != null ? _b : view.results) != null ? _c : view.data) != null ? _e : (_d = view.table) == null ? void 0 : _d.rows) != null ? _g : (_f = view.model) == null ? void 0 : _f.rows) != null ? _i : (_h = view.store) == null ? void 0 : _h.rows;
...
function extractPath(row) {
  ...
  const candidatePaths = [
    ...
    row.linkpath,
    row.file,
    (_a = row.file) == null ? void 0 : _a.path,
    (_b = row.file) == null ? void 0 : _b.filePath,
    (_c = row.file) == null ? void 0 : _c.filepath,
    (_d = row.file) == null ? void 0 : _d.linkpath,
    row.link,
    (_e = row.link) == null ? void 0 : _e.path,
    (_f = row.link) == null ? void 0 : _f.linkpath,
    (_g = row.value) == null ? void 0 : _g.path,
    (_h = row.value) == null ? void 0 : _h.filePath,
    (_i = row.value) == null ? void 0 : _i.linkpath,
    (_j = row.record) == null ? void 0 : _j.path,
    (_k = row.record) == null ? void 0 : _k.file,
    (_m = (_l = row.record) == null ? void 0 : _l.file) == null ? void 0 : _m.path
  ];
...
function resolveFileFromRow(app, row) {
...
function resolveFileByPath(app, candidatePath) {
...
function collectStringCandidates(root) {
  root = unwrapRowValue(root);
  if (root == null || typeof root !== "object") {
    return [];
  }
  ...
  const visited = new WeakSet();
  const queue = [{ value: root, depth: 0, key: "root" }];
  const MAX_DEPTH = 4;
  const MAX_NODES = 120;
  const preferred = [];
  const others = [];
...
function collectFunctionRowCandidates(rowFn) {
  const candidates = [];
  const keyCandidates = [
    "path",
    "file",
  ...
  try {
    const fnObjCandidates = collectStringCandidates(rowFn);
    candidates.push(...fnObjCandidates);
  } catch (e) {
  }
  return [...new Set(candidates)];
}
function resolveFilesFromBasesDom(app) {
  const dedup = new Set();
  const files = [];
  const candidateLeaves = pickPreferredLeavesForDom(app);
  candidateLeaves.forEach((leaf) => {
    var _a;
    const containerEl = (_a = leaf == null ? void 0 : leaf.view) == null ? void 0 : _a.containerEl;
...
function collectFilesFromContainer(app, containerEl, dedup, files) {
  ...
  preferredBasesSelectors.forEach((selector) => {
    var _a;
    try {
      nodeList.push(...Array.from((_a = containerEl.querySelectorAll(selector)) != null ? _a : []));
    } catch (e) {
    }
  });
  ...
  uniqueNodes.forEach((element) => {
    ...
    const raw = (_f = (_e = (_c = (_a = element == null ? void 0 : element.getAttribute) == null ? void 0 : _a.call(element, "data-href")) != null ? _c : (_b = element == null ? void 0 : element.dataset) == null ? void 0 : _b.href) != null ? _e : (_d = element == null ? void 0 : element.getAttribute) == null ? void 0 : _d.call(element, "href")) != null ? _f : "";
...
function pickPreferredLeavesForDom(app) {
  var _a, _b, _c, _d;
  const leaves = [];
  const activeLeaf = (_a = app.workspace) == null ? void 0 : _a.activeLeaf;
  if (activeLeaf != null) {
    leaves.push(activeLeaf);
  }
  const leafTypes = ["bases", "base", "bases-view"];
  for (const type of leafTypes) {
    const sameTypeLeaves = (_d = (_c = (_b = app.workspace) == null ? void 0 : _b.getLeavesOfType) == null ? void 0 : _c.call(_b, type)) != null ? _d : [];
    sameTypeLeaves.forEach((leaf) => leaves.push(leaf));
  }
  const dedup = new Set();
  const ordered = [];
  leaves.forEach((leaf) => {
...
function isElementVisible(element) {
  ...
  const style = element == null ? void 0 : element.style;
  ...
  if (((_a = row == null ? void 0 : row.style) == null ? void 0 : _a.display) === "none" || ((_b = row == null ? void 0 : row.style) == null ? void 0 : _b.visibility) === "hidden") {
    return false;
  }
  if (typeof element.getClientRects === "function") {
    const rects = element.getClientRects();
    if (rects != null && rects.length === 0 && (element == null ? void 0 : element.offsetParent) == null) {
      return false;
    }
  }
  return true;
}
function normalizeHrefToPath(raw) {
...
function unwrapRowValue(value) {
  ...
  try {
    const source = (_b = (_a = value.toString) == null ? void 0 : _a.call(value)) != null ? _b : "";
...
function discoverRowsDeep(root) {
  if (root == null || typeof root !== "object") {
    return null;
  }
  const visited = new WeakSet();
...
// src/command/bases-command.ts
var BasesCommand = class {
  constructor(plugin) {
    this.plugin = plugin;
  }
  regist() {
...
// main.ts
var FileCookerPlugin = class extends import_obsidian31.Plugin {
  onload() {
    return __async(this, null, function* () {
...
var FileCookerSettingTab = class extends import_obsidian31.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian31.Setting(containerEl).setName("Limit").setDesc("config batch file limit").addText((text) => text.setPlaceholder("Enter batch file limit").setValue(this.plugin.settings.limit).onChange((value) => __async(this, null, function* () {
      this.plugin.settings.limit = value;
      yield this.plugin.saveSettings();
    })));
    new import_obsidian31.Setting(containerEl).setName("flomoAPI").setDesc("config flomo API to sync notes").addText((text) => text.setPlaceholder("Enter flomo API").setValue(this.plugin.settings.flomoAPI).onChange((value) => __async(this, null, function* () {
