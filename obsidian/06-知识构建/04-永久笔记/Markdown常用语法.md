...
快乐学习：
![](Extras/Media/822aa2e4d309d8c021f7bca12a0bb882_MD5.webp)
显示效果：
...
\sum\_{i=1}^n a*i=0
f(x_1,x_x,\ldots,x_n) = x_1^2 + x_2^2 + \cdots + x_n^2
\sum^{j-1}*{k=0}{\widehat{\gamma}\_{kj} z_k}
...
![](http://www.forkosh.com/mathtex.cgi? \sum\_{i=1}^n a_i=0)
效果：
...
![](http://www.forkosh.com/mathtex.cgi? \sum^{j-1}*{k=0}{\widehat{\gamma}*{kj} z_k})
效果：
